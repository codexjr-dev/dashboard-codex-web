...
This project is under license **GNU General Public License v3.0 (GNU GPLv3)** - see the file [LICENSE.md](https://github.com/codexjr-dev/dashboard-codex-web/blob/iss%2384/LICENSE.md) for details.
